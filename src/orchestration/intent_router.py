...
class IntentRouter:
    ...
    def __init__(self, endpoint_url="http://127.0.0.1:8082/v1/chat/completions"):
        ...
        self.system_prompt = (
            ...
            "Schema: {\"route\": \"VLM\" or \"OCR\", \"cause\": \"one line reason in Korean\"}\n\n"
            "Example 1:\n"
            '{"route": "VLM", "cause": "화면 전체의 정체(무슨 화면인지)를 묻는 질문이므로 시각적 이해가 필요함"}\n\n'
            "Example 2:\n"
            '{"route": "OCR", "cause": "화면에 적힌 내용을 요약해 달라고 했으므로 텍스트 파악이 중요함"}'
        )
